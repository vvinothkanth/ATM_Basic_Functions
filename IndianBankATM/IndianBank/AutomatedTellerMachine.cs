...
namespace IndianBank
{
    ...
    public class AutomatedTellerMachine
    {
        ...
        /// </summary>
        private Dictionary<int, string> MiniStatement
        {
        ...
        public bool IsValidCustomer( string customerName, int atmPinNumber )
        {
            ...
            try
            {
                if ( atmPinNumber.Equals( AtmPinNumber ) && customerName.Contains( CustomerName ) )
                {
        ...
        public string GetAccountBalance( string customerName, int atmPinNumber )
        {
            ...
            try
            {
                ...
                {
                    accountBalanceStatement = Convert.ToString( AccountBalance );
                }
                else
                {
        ...
        public string SetMiniStatement( string transactionType, double transactionAmount )
        {
            ...
            try
            {
                ...
                int miniStatementCount = MiniStatement.Count;

                MiniStatement.Add(miniStatementCount, statment);
                miniStatement = MiniStatement[miniStatementCount];
            }
        ...
        public string GetMiniStatement( string customerName, int pinNumber  )
        {
            ...
            try
            {
                if ( IsValidCustomer( customerName, pinNumber) )
                {
                    for ( int miniStatementCount = 0; miniStatementCount < MiniStatement.Count; miniStatementCount++ )
                    {
                        miniStatmentSummary += MiniStatement[ MiniStatement.Keys.ElementAt( miniStatementCount ) ] + "\n";
                    }
                }
                else
                {
